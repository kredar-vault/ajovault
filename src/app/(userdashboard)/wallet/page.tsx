...
export default function WalletDashboard() {
  ...
  // Fallback defaults
  const summary = walletSummary || { availableBalance: 0, totalContributed: 0, totalReceived: 0, nextPayout: 0, activeGroups: 0, totalGroups: 0 };
  const bankAccount = {
  ...
  return (
    <div className="w-full min-h-screen bg-[#FAFAFA] p-6 md:p-8 space-y-6 font-sans">
      ...
      {activeModal === "withdraw" && <WithdrawModal balance={summary.availableBalance} bankAccount={summary.bankAccount} onClose={() => setActiveModal(null)} />}
